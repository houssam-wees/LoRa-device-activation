...
static const PROGMEM u1_t NWKSKEY[16] ={ 0x18, 0x15, 0xCE, 0xD4, 0x08, 0x54, 0x48, 0x5C, 0xB7, 0x8F, 0x2A, 0xB1, 0x93, 0xC8, 0xB5, 0xBB };
static const PROGMEM u1_t APPSKEY[16] ={ 0x8A, 0xCB, 0x0A, 0x47, 0x54, 0x39, 0xF2, 0x13, 0x56, 0xDA, 0xF9, 0x00, 0x42, 0xEF, 0x3B, 0x84 };
static const u4_t DEVADDR = 0x26013810; // <-- Change this address for every node!
...
void onEvent (ev_t ev) {
    ...
    switch(ev) {
        case EV_TXCOMPLETE:
           ...
           //os_setTimedCallback(&sendjob, os_getTime()+sec2osticks(1000), do_send);
           delay(2000);
           u8x8.clearLine(1);
           u8x8.clearLine(2);
           u8x8.clearLine(3);
...
void setup() {
    ...
    u8x8.drawString(0, 0, "Hello LoRa");
